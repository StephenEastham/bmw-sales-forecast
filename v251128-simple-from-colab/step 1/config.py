"""Step 1: Minimal config module

This `config.py` is intentionally small and self-contained so a human can
copy it into a real project and understand the patterns:
- project root and outputs directory handling
- centralised constants (URLs, filenames)
- light-weight plotting/pandas config

Keep this file small when you're learning; avoid runtime side-effects that do
network I/O or heavy processing here.
"""
