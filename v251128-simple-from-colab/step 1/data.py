"""Step 1: Minimal data module

This is the first data-related module. It demonstrates clean separation of
concerns: small functions with clear responsibilities and docstrings.

A human can copy these functions into a file in their project and expand them.
"""
import os
import pandas as pd
import requests
...
def download_data_file(file_name: str, data_url: str = DATA_CSV_URL) -> None:
